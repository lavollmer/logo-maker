...
class Square extends Shape {
  renderSVG() {
    ...
    <rect x="150" y="100" width="100" height="100" fill="${this.setColor}"/>
    <text x="150" y="100" font-size="20" text-anchor="middle" fill="${this.colorTextLogo}"> ${this.textLogo}</text>
    </svg>`
  }
}
...
class Circle extends Shape {
  renderSVG() {
    return `<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="150" y="125" font-size="60" text-anchor="middle" fill="${this.colorTextLogo}">${this.textLogo}</text>
